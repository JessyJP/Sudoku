from sudoku import compilePDF
from sudoku3d import *  # Ensure your 3D implementations are in this module
import numpy as np
from sudoku3d.solver_3d import Initialize3DBoard, initialize_3d_solution_space, backtrackMostConstrained3D, \
    solve3D_by_all_slices, solve3D_alt1, backTrackGenerate3D, backTrackGenerate3D2, \
    backTrackGenerate3D3, isValidSudoku3D_slices
from sudoku.solver import *
from sudoku3d.visualize_3d import print_full_solution_space, print_layers, plot_board_state_3d, update_plot_board_state_3d
from sudoku3d.export_3d import export_board_to_TEX_3d, compile_TEX_to_PDF, export_board_to_html_3d, open_pdf, open_html, \
    save_sudoku_board_3d, export_3d_board_to_TEX

# =======================================================
# Script Configuration
# =======================================================
# Define grid size for the Sudoku puzzle
g = 2  # Grid size for blocks (e.g., 3 for a 27x27x27 board)
...
B, success = backTrackGenerate3D3(B,voxel_grid=voxel_grid, refreshCount=1000, random_try=False, try_to_solve=False)
